...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.tokensense-ai.com/tools/context-visualizer',
  },
  openGraph: {
    ...
    url: 'https://www.tokensense-ai.com/tools/context-visualizer',
    type: 'website',
...
export default function ContextVisualizerPage() {
  return (
    <main>
      ...
      {/* Visualization Canvas and Parameter Inputs */}
