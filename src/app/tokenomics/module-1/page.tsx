        ...
        <section className="space-y-12 relative">
          <div className="flex items-center gap-4 border-l-4 border-indigo-500 pl-6 py-2">
            <div className="space-y-1">
              <h2 className="text-sm font-black text-indigo-400 uppercase tracking-[0.3em]">Lesson 1.1</h2>
              <h3 className="text-3xl font-bold text-white tracking-tight">The Anatomy of a Token</h3>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 gap-12">
            <div className="prose prose-invert max-w-none space-y-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  ...
                  <Card className="p-6 bg-slate-950 border-indigo-500/20 space-y-4">
                    ...
                    <p className="text-[10px] text-slate-400 leading-relaxed font-medium">
                      ...
                      <span className="block mt-2 text-white/70">Rule: 1 token ≈ 4 characters.</span>
                    </p>
              ...
              <div className="space-y-8 pt-12">
                <div className="flex items-center gap-4 border-l-4 border-indigo-500 pl-6 py-2">
                    <div className="space-y-1">
                    <h2 className="text-sm font-black text-indigo-400 uppercase tracking-[0.3em]">Lesson 1.2</h2>
                    <h3 className="text-3xl font-bold text-white tracking-tight">How Tokenizers Actually Work (BPE)</h3>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card className="p-6 bg-slate-950 border-white/5 space-y-4 relative">
                            ...
                            <p className="text-[10px] text-slate-500">Break everything down to the smallest units.</p>
                        </Card>
                        ...
                        <Card className="p-6 bg-slate-950 border-indigo-500/20 space-y-4 relative">
                            ...
                            <p className="text-[10px] text-indigo-300">"un" wins and becomes a new token.</p>
                        </Card>
                        ...
                        <Card className="p-6 bg-indigo-500/10 border-indigo-500/40 space-y-4 relative">
                            ...
                            <p className="text-[10px] text-indigo-200 leading-relaxed">Next most frequent pair "ug" is merged. Repeat until pre-defined Vocabulary Size is reached.</p>
                            <div className="flex flex-wrap gap-2">
              ...
              <div className="space-y-8 pt-12">
                <div className="flex items-center gap-4 border-l-4 border-emerald-500 pl-6 py-2">
                    <div className="space-y-1">
                    <h2 className="text-sm font-black text-emerald-400 uppercase tracking-[0.3em]">Lesson 1.3</h2>
                    <h3 className="text-3xl font-bold text-white tracking-tight">The Multilingual Token Penalty</h3>
                    </div>
                </div>
                ...
                <div className="bg-slate-900/50 border border-white/5 rounded-3xl p-8 space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-4 border-t border-white/5">
                        <div className="space-y-2">
                            ...
                            <p className="text-[10px] text-slate-400 leading-relaxed">Most LLMs are trained on datasets like "Common Crawl," where ~90% of text is English. Tokenizers are "built" for English.</p>
                        </div>
                        <div className="space-y-2">
                            <h5 className="text-xs font-black text-white uppercase tracking-widest">2. Merging Gap</h5>
                            <p className="text-[10px] text-slate-400 leading-relaxed">Tokenizer sees "the" billions of times and creates an efficient single token. It rarely sees Tamil or Khmer words.</p>
                        </div>
                        <div className="space-y-2">
                            <h5 className="text-xs font-black text-white uppercase tracking-widest">3. Fragmentation</h5>
                            <p className="text-[10px] text-slate-400 leading-relaxed">Rare scripts are treated as collections of individual characters or raw bytes, forcing the AI to work much harder.</p>
                        </div>
                    </div>
                </div>
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card className="p-6 bg-slate-950 border-red-500/20 space-y-3">
                            ...
                            <p className="text-[10px] text-slate-400 leading-relaxed">If "Hello" is 1 token in English but 6 in Hindi, the Hindi user is charged 600% more for the same meaning.</p>
                        </Card>
                        <Card className="p-6 bg-slate-950 border-amber-500/20 space-y-3">
                            ...
                            <p className="text-[10px] text-slate-400 leading-relaxed">An English user can fit a whole novel in memory; a Kannada user might only fit a few chapters before the AI "forgets."</p>
                        </Card>
                        <Card className="p-6 bg-slate-950 border-indigo-500/20 space-y-3">
                            ...
                            <p className="text-[10px] text-slate-400 leading-relaxed">AI generates one token at a time. English outputs syllables; penalized scripts output character-fragments, feeling "slower."</p>
                        </Card>
                    </div>
                </div>
                ...
                <div className="p-8 bg-slate-900 border border-white/5 rounded-3xl space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-2">
                            ...
                            <p className="text-[10px] text-slate-500 leading-relaxed font-medium">Some models (Gemini 3, Qwen) use massive vocabularies (200k+) specifically optimized for non-Latin scripts.</p>
                        </div>
                        <div className="space-y-2">
                            <p className="text-xs font-bold text-white uppercase tracking-widest">2. Hybrid Prompting</p>
                            <p className="text-[10px] text-slate-500 leading-relaxed font-medium">Give instructions in English and only ask for output in the target language to minimize high-cost input tokens.</p>
                        </div>
                    </div>
                </div>
              ...
              <div className="space-y-12 pt-12">
                <div className="flex items-center gap-4 border-l-4 border-purple-500 pl-6 py-2">
                    <div className="space-y-1">
                    <h2 className="text-sm font-black text-purple-400 uppercase tracking-[0.3em]">Lesson 1.4</h2>
                    <h3 className="text-3xl font-bold text-white tracking-tight">The Token Autopsy: From Text to Vector</h3>
                    </div>
                </div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <Card className="p-6 bg-slate-950 border-white/5 space-y-4">
                            <h5 className="text-xs font-black text-indigo-400 uppercase tracking-widest">1. Surface Identity</h5>
                            <p className="text-[10px] text-slate-400 leading-relaxed">The human-readable string. Algorithms like BPE slice text into the most efficient chunks possible.</p>
                        ...
                        <Card className="p-6 bg-slate-950 border-white/5 space-y-4">
                            <h5 className="text-xs font-black text-emerald-400 uppercase tracking-widest">2. Numerical Identity</h5>
                            <p className="text-[10px] text-slate-400 leading-relaxed">The unique integer ID assigned to every token in the vocabulary. The AI only understands these numbers.</p>
                        ...
                        <Card className="p-6 bg-slate-950 border-white/5 space-y-4">
                            <h5 className="text-xs font-black text-amber-400 uppercase tracking-widest">3. Semantic Identity</h5>
                            <p className="text-[10px] text-slate-400 leading-relaxed">The <b>Embedding Vector</b>. A list of 4,096+ numbers representing the "meaning" and its relation to other tokens.</p>
                ...
                <div className="p-6 bg-purple-500/5 border border-purple-500/20 rounded-2xl flex items-start gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-slate-400">GPT-5.4 uses the <span className="text-white font-mono">o200k_base</span> vocabulary. The special token <span className="text-purple-400 font-mono">{"<|im_start|>"}</span> is assigned to ID <span className="text-white font-bold">200264</span>.</p>
                    </div>
                </div>
              </div>
