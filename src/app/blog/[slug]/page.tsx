      ...
      <main className="flex-1 mx-auto w-full max-w-4xl px-4 sm:px-6 lg:px-8 py-10 md:py-16">
        ...
        <section className="sr-only">
          <article>
            ...
            <div>
              <p>Explore more on LLM cost optimization and token counting at Tokensense-Ai.</p>
              <nav>
                <ul>
                  <li><Link href="/">Token Counter</Link></li>
                  <li><Link href="/workflow">Workflow Estimator</Link></li>
                  <li><Link href="/comparison">Model Comparison</Link></li>
                </ul>
              </nav>
            </div>
          </article>
        ...
        <footer className="mt-16 pt-8 border-t border-border/40">
          <div className="flex flex-wrap items-center justify-between gap-6">
            <BlogPostShare url={`/blog/${post.slug}`} title={post.title} />
